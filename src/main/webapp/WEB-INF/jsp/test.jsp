			...
			<div>
				<div class="P_top">
					<div class="P_logo">
						<div class="anh_logo">
							<!-- <img alt=""
								src=".Banner Hoi nghi quoc te sua.jpg"
								style="width: 800px; height: 188px;"><br> -->
						<img src="${pageContext.request.contextPath}src/main/WEB-INF/jsp/WELCOME TO ICSSE 2017_files/Banner Hoi nghi quoc te sua.jpg" 
						style="width: 800px; height: 188px;"/><br>
						</div>
